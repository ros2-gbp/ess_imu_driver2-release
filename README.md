## ess_imu_driver2 (jazzy) - 2.0.4-1

The packages in the `ess_imu_driver2` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy ess_imu_driver2` on `Mon, 20 Jul 2026 16:36:18 -0000`
...
## ess_imu_driver2 (humble) - 2.0.2-1
